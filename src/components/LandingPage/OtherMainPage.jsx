...
function OtherMainPage() {
  return (
    <>


      <main className='bg-zinc-950 min-h-screen h-full min-w-full w-full overflow-x-hidden'>
        ...
        <div className=''>
          <div className='absolute -top-16 -left-64 w-blurW h-blurH bg-purple-400 rounded-full filter blur-3xl opacity-50 animate-animateBlurp'></div>
          <div className='flex items-end justify-end flex-row'>
            <div className='absolute  top-0 w-blurW2 h-blurH bg-red-500 rounded-full filter blur-3xl opacity-70 animate-animateBlurp animation-delay-2000'></div>
            <div className='relative top-64'>
              <div className='absolute  -right-20 w-blurW h-blurH bg-orange-400 rounded-full filter blur-3xl opacity-60 animate-animateBlurp animation-delay-4000 '></div>
            </div>
          </div>
        </div>
